class EnemiesDataList
  attr_reader :slime, :slime2, :big_slime
  ...
  def initialize
    ...
    @slime.stage_is(:any) do |me, tick, _player|
    ...
    @slime2.stage_is(:any) do |me, tick, _player|
      tick = me.spawn_tick - tick
      me.collision = [64, 100, 27]
      me.y += 2
      me._anime_next if tick % 10 == 0
    ...
    @big_slime.stage_is(:any) do |me, tick, _player|
      me.y += 2
