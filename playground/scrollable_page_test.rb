...
page = ScrollablePage.new(500, 400, 500, 800, [34, 34, 34])
...
Window.loop do
  ...
  usage.length.times do |i|
    page.draw_font(10, 140 + font_code.size*i, usage[i], font_code)
  end
  ...
  Window.draw_font(10, 10, "#{page.pos}", font)
end
